...
<html>
	<head>
		...
		<script>
			...
			function ajaxPy2(){
				$.ajax('pythoncall2.php', { success: function(){
					$("#DisplayButt").html('<iframe style="display: block; margin: 0 auto" src="finaltable.txt" width=1000 height=200 frameborder=0 ></iframe>')
				}})
			}
		</script>
    ...
    <body>
		...
		<input type='button' id='submitBtn' class='submitBtn' value='submit' onclick="ajaxPy1()"></input>
		<input type='button' id='submitBtn' class='submitBtn' value='submit' onclick="ajaxPy2()"></input>
    </body>
</html> 